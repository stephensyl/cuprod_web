            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide-3d">
                    <div class="artist-card">
                        ...
                        <h3>KIZU - Eric Yen</h3>
                        <p>My music is a collage of underground genres, gathering inspiration from artists like Bixby, Ericdoa, Wolfacejoeyy, Avenoire, and more. I started making music as a hobby in high school and haven’t been able to stop since. I will be on the upcoming album, both as a producer and an artist so stay tuned!!</p>
                        <a href="#" class="streaming-link">Listen on Spotify</a>
                    </div>
                </div>
                <!-- Slide 2 -->
                <div class="swiper-slide-3d">
